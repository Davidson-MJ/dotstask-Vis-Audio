...
%          PsychImaging('PrepareConfiguration');
          [window.Number , window.Rect] = PsychImaging('OpenWindow', windowin, window.BGColor, [0 0 1920 1080], [], [], window.StereoMode,window.MultiSample, window.ImagingPipeline);
%     else
...
%     end
    ...
    if window.StereoMode == 4
        PsychImaging('PrepareConfiguration');
        [window.Number , window.Rect] = PsychImaging('OpenWindow', windowin, window.BGColor, [100 20 1980 1080], [], [], window.StereoMode,window.MultiSample, window.ImagingPipeline);
    else
        [window.Number , window.Rect] = Screen('OpenWindow', windowin, window.BGColor,[100 20 1980 1080],[],[],window.StereoMode,window.MultiSample, window.ImagingPipeline);
    end
end
