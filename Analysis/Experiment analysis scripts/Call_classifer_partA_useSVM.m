...
my_SVM_ECOC_ERP_Decoding(pfols);  
...
% 
% %% In this version, the classifier is trained using SVM, based on example
% %given by Bae & Luck 2018.
% 
% my_SVM_ECOC_ERP_Decoding(ppantnum);  
% 
